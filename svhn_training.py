...
def main():
    parser = argparse.ArgumentParser(description='Adv Train PGD')
    ...
    train_loader, val_loader = get_train_valid_loader('../data', args.train_batch_size, True, args.seed, 0.1 if args.train_val_split else 0, pin_memory=True, dataset='SVHN')
    if args.train_val_split == False:
        val_loader = get_test_loader('../data', args.test_batch_size, False, pin_memory=True, dataset='SVHN')

    # We use same model for CIFAR and SVHN
