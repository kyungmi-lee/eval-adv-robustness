...
def main():
    ...
    if args.eval_on_trainset:
         train_loader, val_loader = get_train_valid_loader('../data', args.batch_size, True, args.seed, 0.1 if \
                                                           args.train_val_split else 0, pin_memory=True, dataset='SVHN')
           
         test_loader = train_loader
    else:
        test_loader = torch.utils.data.DataLoader(datasets.SVHN('../data', split='test', download=True, transform=transform_test),\
